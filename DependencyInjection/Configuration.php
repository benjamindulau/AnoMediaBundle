...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('ano_media');
                ...
                ->arrayNode('cdn')
                    ...
                    ->prototype('array')
                        ->beforeNormalization()
                            ...
                            ->thenInvalid('The ano_media.cdn config "%s" must be an array.')
                        ->end()
                        ->addDefaultsIfNotSet()
                        ->children()
            ...
            ->children()
                ->arrayNode('provider')
                    ...
                    ->prototype('array')
                        ->beforeNormalization()
                            ->ifTrue(function($v) { return !is_array($v); })
                            ->thenInvalid('The ano_media.provider config "%s" must be an array.')
                        ->end()
                        ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('default')->defaultValue(false)->end()
                    ...
                    ->children()
                        ->arrayNode('path')
                            ...
                            ->prototype('array')
                                ->beforeNormalization()
                                    ->ifTrue(function($v) { return !is_array($v); })
                                    ->thenInvalid('The ano_media.generator.path config "%s" must be an array.')
                                ->end()
                                ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('default')->defaultValue(false)->end()
                        ...
                        ->arrayNode('uuid')
                            ...
                            ->prototype('array')
                                ->beforeNormalization()
                                    ->ifTrue(function($v) { return !is_array($v); })
                                    ->thenInvalid('The ano_media.generator.uuid config "%s" must be an array.')
                                ->end()
                                ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('default')->defaultValue(false)->end()
            ...
            ->children()
                ->arrayNode('filesystem')
                    ...
                    ->prototype('array')
                        ->beforeNormalization()
                            ->ifTrue(function($v) { return !is_array($v); })
                            ->thenInvalid('The ano_media.filesystem config "%s" must be an array.')
                        ->end()
                        ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('default')->defaultValue(false)->end()
            ...
            ->children()
                ->arrayNode('contexts')
                    ...
                    ->prototype('array')
                        ->beforeNormalization()
                            ->ifTrue(function($v) { return !is_array($v); })
                            ->thenInvalid('The ano_media.contexts config "%s" must be an array.')
                        ->end()
                        ->children()
