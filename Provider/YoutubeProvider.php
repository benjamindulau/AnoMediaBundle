...
{
    /* @var string */
    protected $template = 'AnoMediaBundle:Youtube:view.html.twig';
    ...
    protected function getMetadata(Media $media)
    {
        ...
        $url = sprintf('http://www.youtube.com/oembed?url=http://www.youtube.com/watch?v=%s&format=json', $media->getContent());
     ...
     * {@inheritDoc}
     *
     * Source and copyright : https://github.com/sonata-project/SonataMediaBundle/blob/master/Provider/YouTubeProvider.php
     */
